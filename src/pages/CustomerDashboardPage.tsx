...
import { OrderItem, BookingItem } from '../types';
...
export const CustomerDashboardPage: React.FC<CustomerDashboardPageProps> = ({
  ...
  const [activeSubTab, setActiveSubTab] = useState<
    'vault' | 'upload' | 'orders' | 'selection' | 'downloads' | 'payments'
  >('vault');
  ...
  return (
    <div id="customer-dashboard" className="min-h-screen bg-[#09090b] text-zinc-100 pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">
                Access wedding photos, approve album proofs, request retouch adjustments, and download invoices.
              </p>
            </div>
          </div>
        ...
        {/* 2. PHOTO SELECTION FOR ALBUM (Prompt 20 / Rule G, H, N requirement) */}
